 ...
 *
 */
public class ServerDirListFragment extends ListFragment implements ContentDirectoryCallback, ConnectionObserver{
	...
	private Directory transitionDirectory;
	...
	public void onResume(){
		...
		if(transitionDirectory!=null && !newDeviceConnected){//check to see if there was previously a directory being shown.
			setFileStructure(transitionDirectory);//if there is then show that directory.
		}else{
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		if(item.getType() == MediaObject.mediaType.StorageFolder){
			...
			pd.show();
			mCallback.onContainerSelected(item);
	...
	public void onPause(){
		super.onPause();
		transitionDirectory = currentDirectory;
	}
